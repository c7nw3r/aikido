...
@dataclass
class TextKata(ArrowKata):
    """ Kata implementation which loads a text file. """
    spec: KataSpec
    ...
    def get_dataset(self) -> Dataset:
        return self.preprocess(load_dataset('text', data_files=[self.data_files], encoding="utf-8")["train"])
