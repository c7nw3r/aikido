...
aikidoka = TripletSelectorHead(ResNet(headless=True), HardestNegativeTripletSelector(1.))

dojo = TripletDojo(DojoKun(dans=10, batch_size=24), EvaluationListener(dataset_test, [], evaluate_every=5))
dojo.train(aikidoka, dataset_train)

aikidoka.save("./model2.pt")
